...
export function Footer() {
  return (
    <footer className="overflow-hidden bg-background py-8 px-4 lg:py-16 lg:px-16">
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col justify-between gap-10 lg:flex-row">
              <div className="max-w-73 space-y-6">
                <h3 className="text-[28px] font-medium leading-8 text-foreground md:text-[32px]">Igor Ferrão</h3>
            ...
            <p className="text-sm leading-5 text-muted-foreground">2026 Igor. All rights reserved</p>
          </div>
        </div>
